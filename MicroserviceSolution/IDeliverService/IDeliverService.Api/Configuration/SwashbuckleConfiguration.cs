...
using IDeliverService.Api.Filters;
...
namespace IDeliverService.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "IDeliverService API V1");
                    options.OAuthAppName("IDeliverService API");
