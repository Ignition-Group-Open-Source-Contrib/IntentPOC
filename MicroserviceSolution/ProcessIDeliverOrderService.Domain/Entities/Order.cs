...
namespace ProcessIDeliverOrderService.Domain.Entities
{
    ...
    public class Order : IHasDomainEvent
    {
        ...
        public virtual ICollection<IDeliverOrderInfo> IDeliverOrderInfos { get; set; } = new List<IDeliverOrderInfo>();
