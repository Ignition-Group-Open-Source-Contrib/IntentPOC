...
using MarketicOrderService.Api.Filters;
...
namespace MarketicOrderService.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "MarketicOrderService API",
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "MarketicOrderService API V1");
                    options.OAuthAppName("MarketicOrderService API");
