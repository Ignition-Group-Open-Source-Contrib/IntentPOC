...
using SSIDeliverIntegrationService.Api.Filters;
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "SSIDeliverIntegrationService API",
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "SSIDeliverIntegrationService API V1");
                    options.OAuthAppName("SSIDeliverIntegrationService API");
