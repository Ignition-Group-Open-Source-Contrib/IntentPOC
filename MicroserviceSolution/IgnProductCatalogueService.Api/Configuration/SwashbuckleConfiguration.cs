...
using IgnProductCatalogueService.Api.Filters;
...
namespace IgnProductCatalogueService.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "IgnProductCatalogueService API",
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "IgnProductCatalogueService API V1");
                    options.OAuthAppName("IgnProductCatalogueService API");
